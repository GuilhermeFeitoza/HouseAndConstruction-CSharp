        ...
        public void Incluir()
        {
            try
            {
                ...
                SqlParameter[] listaComParametros =
                    {
                  new SqlParameter("@DescricaoPeriodo",SqlDbType.VarChar) {Value = _DescricaoPeriodo },
                   new SqlParameter("@SinalPeriodo",SqlDbType.VarChar) {Value = _SinalPeriodo },
                  new SqlParameter("@ValorPeriodo",SqlDbType.Int) {Value = _ValorPeriodo },
                  new SqlParameter("@StatusPeriodo",SqlDbType.Bit) {Value = _StatusPeriodo }
                };
